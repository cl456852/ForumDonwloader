...
namespace WindowsFormsApplication1
{
    public class YouivProcessor : IPageProcessor
    {
        ...
        public void NavigateHandle(System.Windows.Forms.WebBrowser webBrowser1, System.Windows.Forms.WebBrowserDocumentCompletedEventArgs e, string path1)
        {
            ...
            //if (!e.Url.ToString().Contains("youiv.tv/u15-279") &&!e.Url.ToString().Contains("youiv./youiv-"))
            //{
            ...
            else
            {
                ...
                {
                    string url = "https://www.youiv.tv/" + match.Value.Split(new string[] { "<a href=\"", "\"" }, StringSplitOptions.RemoveEmptyEntries)[0];
